      ...
      <div class="row">
        <div class="col">
          <ul class=" score-a list-group match-card list-group-flush mt-2">
            ...
            <li v-if="showResults"
                class="list-group-item match-card p-0 d-flex justify-content-center goals">
              {{
...
export default {
  ...
  computed: {
    ...
    showResults() {
      return Object.prototype.hasOwnProperty.call(this.results, this.teams[1])
      && Object.prototype.hasOwnProperty.call(this.results, this.teams[0])
